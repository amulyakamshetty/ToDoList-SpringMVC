...
public class TodoController {
	...
	public String addTodo(ModelMap model, @RequestParam String desc, @Valid Todo todo, BindingResult result ) {
		if(result.hasErrors()){
			return "todo";
		}
		service.addTodo(retrieveLoggedinUserName(), desc, new Date(), false);
		model.clear();
